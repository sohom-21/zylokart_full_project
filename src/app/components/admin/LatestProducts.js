        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-gray-200">
              ...
              <th className="text-left py-3 px-2 font-medium text-gray-600 text-sm">Sales</th>
              <th className="text-left py-3 px-2 font-medium text-gray-600 text-sm">Change</th>
            </tr>
          </thead>
          <tbody>
            {products.map((product) => {
              const ChangeIcon = product.isPositive ? ArrowUpRight : ArrowDownRight
              return (
                <tr key={product.id} className="border-b border-gray-100 hover:bg-gray-50">
                  ...
                  <td className="py-4 px-2 font-medium text-gray-900">{product.price}</td>
